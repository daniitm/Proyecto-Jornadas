                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->isAdmin())
                        ...
                        <x-nav-link :href="route('inscripciones.index')" :active="request()->routeIs('inscripciones.index')">
                            {{ __('Inscripciones (Admin)') }}
                        </x-nav-link>
                    @else
                        <x-nav-link :href="route('user.ponentes.index')" :active="request()->routeIs('user.ponentes.index')">
                            {{ __('Ponentes') }}
                        </x-nav-link>
                        <x-nav-link :href="route('user.eventos.index')" :active="request()->routeIs('user.eventos.index')">
                            {{ __('Eventos') }}
                        </x-nav-link>
                    @endif
                </div>
